...
class AsyncData(AsyncAPIResource):
    ...
    async def read_single_range_data(
        ...
        *,
        range: str,
        valueRenderOption: Literal[
            "ToString", "Formula", "FormattedValue", "UnformattedValue"
        ]
        | None = None,
        dateTimeRenderOption: Literal["FormattedString"] | None = None,
        ...
        Args:
            ...
            timeout (httpx.Timeout | None, optional): _description_. Defaults to None.
